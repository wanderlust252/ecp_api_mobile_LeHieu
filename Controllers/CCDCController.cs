...
namespace ECP_WEBAPI.Controllers
{
    ...
    { 
        ...
        [Route("NhomThietBi")]
        [HttpGet]
        public async Task<object> getNhomThietBi(string dbname)
        { 
            try
            {
                ...
                using (SqlConnection db = new SqlConnection(GetConnectString(dbname)))
                {
                    ...
                    return (await db.QueryAsync<object>(query, new { })).ToList();
                }
            }
            catch (Exception ex) { }
            return null;
        ...
        [Route("CCDCTrangThai")]
        [HttpGet]
        public async Task<object> getCCDCTrangThai(string dbname)
        {
            ...
            try
            {
                ...
                using (SqlConnection db = new SqlConnection(GetConnectString(dbname)))
                {
                    string query = @"select * from CCDC_TrangThai";
        ...
        [Route("LoaiThietBi")]
        [HttpGet]
        public async Task<object> getLoaiThietBi(string MaNhom,string dbname)
        {
            //List<CongCuDungCuAnToanModel> lstData = new List<CongCuDungCuAnToanModel>();
            try
            {
                ...
                using (SqlConnection db = new SqlConnection(GetConnectString(dbname)))
                {
                    ...
                    return (await db.QueryAsync<object>(query, new { MaNhom })).ToList();
                }
            }
            catch (Exception ex) { }
            return null;
        ...
        [Route("CCDCListCounter")]
        [HttpGet]
        public object CCDCListCounter(string filter,
